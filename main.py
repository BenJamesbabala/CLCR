...
# Data generators
train_generator = FT_DataGenerator(train_path, image_size, batch_size, mode, target_classes, filter_classes=filter_classes, augment=True)
val_generator = FT_DataGenerator(valid_path, image_size, batch_size, mode, target_classes, augment=False)
